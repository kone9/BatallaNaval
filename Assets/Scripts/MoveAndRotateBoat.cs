...
public class MoveAndRotateBoat : MonoBehaviourPun
{
    ...
    public GameObject Mover_Y_Rotar_Barcos_AutomaticamentePorCuadricula(GameObject cuadricula)
    {
        ...
        X_posicion_imaginaria = cuadricula.GetComponent<CuadriculaDeColisiones>().Grilla_X_posicion;
        Y_posicion_imaginaria = cuadricula.GetComponent<CuadriculaDeColisiones>().Grilla_Y_posicion;
