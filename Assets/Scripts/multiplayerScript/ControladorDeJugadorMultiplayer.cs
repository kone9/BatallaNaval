...
public class ControladorDeJugadorMultiplayer : MonoBehaviour
{
    ...
    public Button BotonAuto { get => botonAuto; set => botonAuto = value; }
    ...
    {
        if (!waitingForOtherPlayer)//sino esta esperando que se conecten otros
        {
            // //hay un pequeño bug con el movimiento
